...
Page({
    ...
    zhuanfa: function(t) {
        ...
        var s = this, a = (t = app.getCache("userinfo"), new Object());
        a.token = t.token, a.openid = t.openid, a.much_id = app.siteInfo.uniacid, this.data.info.image_part ? 0 < this.data.info.image_part.length && (a.img = this.data.info.image_part[0]) : 1 == this.data.info_zf.whether_open ? a.img = this.data.info_zf.reis_img : a.img = app.http_root + "/addons/yl_welore/web/static/wechat/zhiwen.png";
        ...
        http.POST(e, {
            ...
            success: function(t) {
                ...
                var a = t.data.split(","), e = wx.base64ToArrayBuffer(a[1]), i = wx.env.USER_DATA_PATH + "/share_img" + s.data.id + ".png";
                fsm.writeFileSync(i, e, "binary"), s.setData({
                    fileName: i
                }), wx.getImageInfo({
                    src: i,
                    success: function(n) {
                        wx.getSystemInfo({
                            success: function(t) {
                                var a = n.width / n.height, e = .72 * t.windowWidth / a + 230, i = parseFloat(e);
                                s.setData({
                                    imgheght: i
                                });
                            }
    ...
    sharePosteCanvas: function(u, r) {
        wx.showLoading({
            title: "生成中...",
            mask: !0
        });
        var _ = this, l = _.data.this_user_info, h = wx.createCanvasContext("myCanvas", _), p = "";
        wx.createSelectorQuery().select("#canvas-container").boundingClientRect(function(t) {
            var a = t.height;
            t.right;
            p = t.width;
            t.left;
            if (h.save(), h.setFillStyle("#ffffff"), h.fillRect(0, 0, p, a), u) {
                h.beginPath(), h.fill();
                var e = 10, i = 10, n = u.split(","), s = wx.base64ToArrayBuffer(n[1]), o = wx.env.USER_DATA_PATH + "/head_img" + _.data.id + ".png";
                fsm.writeFileSync(o, s, "binary"), h.arc(25 + e, 25 + i, 25, 0, 2 * Math.PI, !1), 
                h.clip(), h.drawImage(o, e, i, 50, 50);
            }
            h.restore(), h.setFontSize(12), h.setFillStyle("#999"), h.setTextAlign("left"), 
            h.fillText(l.nickName, e + 60, i + 20), h.setFontSize(14), h.setFillStyle("#000"), 
            h.fillText("找到了好东西，给你们看看😊", e + 60, i + 40);
            var c = wx.base64ToArrayBuffer(r), d = wx.env.USER_DATA_PATH + "/code_img" + _.data.id + ".png";
            fsm.writeFileSync(d, c, "binary"), h.drawImage(d, p / 2 - 50, a - 140, 110, 110), 
            h.setFontSize(10), h.setFillStyle("#000"), h.fillText("👆微信扫码或长按识别👆", p / 2 - 50, a - 20), 
            console.log(_.data.fileName), h.drawImage(_.data.fileName, 0, 70, p, _.data.imgheght - 230);
    ...
    get_diy: function() {
        ...
        i.token = e.token, i.openid = e.openid, i.much_id = app.siteInfo.uniacid, i.version = app.version, 
        http.POST(t, {
            params: i,
            success: function(t) {
    ...
    add_sc: function() {
        ...
        e.sc_type = 1 == this.data.info_sc ? 1 : 0;
        ...
        http.POST(i, {
            ...
            success: function(t) {
                console.log(t), "success" == t.data.status ? ($Toast({
                    content: t.data.msg
                }), wx.vibrateShort(), a.setData({
                    info_sc: t.data.info_sc,
        ...
        http.POST(a, {
            ...
            success: function(t) {
                if (console.log(t), "success" == t.data.status) {
                    ...
                    e.setData({
                        huifu_list: s
                    }), 0 == t.data.huifu.length && e.setData({
                        di_msg: !0
                    });
                } else $Toast({
                    content: t.data.msg

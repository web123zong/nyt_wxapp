...
Page({
    ...
    get_my_rec: function() {
        ...
        a.id = this.data.id;
        var n = app.api_root + "User/get_user_banned_qq";
        http.POST(n, {
            params: a,
            success: function(t) {
    ...
    add_envite_sulord: function(t) {
        ...
        n.id = t.currentTarget.dataset.id;
        var i = app.api_root + "User/jie_user_banned";
        http.POST(i, {
            params: n,
            success: function(t) {
    ...
    _navback: function() {
        ...
        1 != t.length ? (e.setData({
            ...
            url: "/community/yl_welore/page/index/index"
        });
    }
});
...
Page({
    ...
    get_my_pay: function() {
        ...
        var i = app.api_root + "User/get_my_video", s = e.data.data_list;
        http.POST(i, {
            params: a,
            success: function(t) {
                if (console.log(t), "success" == t.data.status) {
    ...
    get_my_list: function() {
        ...
        i.token = a.token, i.openid = a.openid, i.much_id = app.siteInfo.uniacid, i.id = this.data.id, 
        i.type = this.data.current, i.index_page = this.data.index_page;
    ...
    del_do: function() {
        ...
        i.paper_id = this.data.paper_id, i.is_qq_text = "", http.POST(t, {
            params: i,
            success: function(t) {

...
Page({
    ...
    onLoad: function(e) {
        ...
        console.log(t), "undefined" != t && this.ger_cor_user_code(t), this.setData({
    ...
    onShow: function(e) {
        console.log(e), app.getCache("userinfo") && this.ger_user_code();
    },
    ...
    sharePosteCanvas: function(u, l) {
        ...
        var d = this, h = d.data.this_user_info, p = wx.createCanvasContext("myCanvas", d), f = "";
        wx.createSelectorQuery().select("#canvas-container").boundingClientRect(function(e) {
            var t = e.height;
            e.right;
            f = e.width;
            e.left;
            p.save(), p.setFillStyle("#FFE200"), p.fillRect(0, 0, f, t);
            p.drawImage("../../../style/icon/1033914-20180419150322109-1754886203.png", 0, 0, f, 150), 
            p.beginPath(), p.fill();
            var a = f / 2 - 25, n = 160, i = u.split(","), o = wx.base64ToArrayBuffer(i[1]), s = wx.env.USER_DATA_PATH + "/head_img.png";
            fsm.writeFileSync(s, o, "binary"), p.arc(25 + a, 185, 25, 0, 2 * Math.PI, !1), p.clip(), 
            p.drawImage(s, a, n, 50, 50), p.restore(), p.setFontSize(20), p.setFillStyle("#000"), 
            p.fillText(h.nickName, (f - p.measureText(h.nickName).width) / 2, 235), p.setFontSize(11), 
            p.setFillStyle("#000"), p.fillText("邀你一起赚赏金", (f - p.measureText("邀你一起赚赏金").width) / 2, 260);
            p.drawImage("../../../style/icon/1033914-20180419150331561-740454292.png", f / 2 - 115, 290, 230, 60), 
            p.setFontSize(35), p.setFillStyle("#FFE200"), p.fillText(d.data.code, (f - p.measureText(d.data.code).width) / 2, 325);
            p.drawImage("../../../style/icon/1033914-20180419150338090-1432865429.png", f / 2 - 125, 390, 130, 70), 
            p.setFontSize(10), p.setFillStyle("#000000"), p.fillText("进入小程序输入朋友的邀", f / 2 - 120, 410), 
            p.fillText("请码，各自都会获得赏金", f / 2 - 120, 425), p.fillText("哦~", f / 2 - 120, 440);
            var c = wx.base64ToArrayBuffer(l), r = wx.env.USER_DATA_PATH + "/code_img.png";
            fsm.writeFileSync(r, c, "binary"), p.drawImage(r, f - 120, 360, 80, 80);
            p.drawImage("../../../style/icon/1033914-20180419150342935-1154229474.png", f - 120, 440, 80, 22);
        }).exec(), setTimeout(function() {
            p.draw(), wx.canvasToTempFilePath({
                canvasId: "myCanvas",
                success: function(e) {
